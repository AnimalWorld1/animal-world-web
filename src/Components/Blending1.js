...
function Blending1() {
    return (
        <div style={{display:'flex',flexDirection:'column',alignItems:'center'}}>
           <img src={BlendingImg1} alt="blendingImg1" style={{width:'65vw'}} />
           <img src={BlendingImg2} alt="blendingImg2" style={{width:'65vw'}} />
           <img src={BlendingImg3} alt="blendingImg3" style={{width:'65vw'}} />
           <img src={BlendingImg4} alt="blendingImg4" style={{width:'65vw'}} /> 
        </div>
    )
}
