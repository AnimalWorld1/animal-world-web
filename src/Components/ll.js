...
import { LoginWax } from "./waxSlice";

const LogIn = (props) => {
  const username = useSelector((state) => state.wax.username);
  console.log(LoginWax);
  ...
  return (
    ...
    >
      <p>To continue please select an option: {username} </p>
      <div
        role="button"
      ...
      >
        <div
          style={{
            ...
            fontFamily: '"Source Sans Pro", sans-serif; display: inline-block',
            float: "left",
            width: "50px",
            padding: "8.5px 10px",
...
a0ZGbzm+W7H4q5bGo8rsEECRIk2Br4D20NhhljafHuAAAAAElFTkSuQmCC"
        ...
        >
          ...
          <span style={{ float: "right", height: "16px", marginTop: "2px" }}>
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
