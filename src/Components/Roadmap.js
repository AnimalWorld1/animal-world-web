...
function Roadmap() {
  return (
    ...
    >
      ...
      <div className="rmap" style={{position:"absolute",top:"28%",left:"11%"}}>
      <div>WEBSITE DEVELOPMENT ___________________ <img src={checktick} style={{width:".9em"}}alt="checked" /></div>
        <div>TREE SALE_______________________________________</div>
      </div>
        <div className="rmap" style={{position:"absolute",top:"51%",left:"11%"}}>
       ...
       <div>LAND SALE_______________________________________</div>
        ...
        <div className="rmap" style={{position:"absolute",top:"78%",left:"17%"}}>
