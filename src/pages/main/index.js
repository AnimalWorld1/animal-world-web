        ...
        <div className="main-page">
            ...
            <section className="main-description">
                ...
                <p className="main-description-text">
                    <span className="main-description-text-emphasize">Animal world</span> is a dynamic, tokenized project built on the carbon-neutral WAX blockchain.  It offers fun simulated gameplay in which players can collect, own, trade, and exchange farming assets, as well as our token, AWC. We at Animal World are committed towards building and enabling a diverse community of ecologically aware individuals who will contribute towards self-sustainable and ecologically positive farming.  The project runs on a real-time basis, with user friendly accessibility.
                </p>
            </section>
            <section className="main-game">
                ...
                <div className="main-game-features">
                    <div className="main-game-feature">
                        ...
                        <p className="main-game-feature-text">Animal World is a Play to Earn game, where players are able to achieve real world earning opportunities through engaging in simulated farming to produce resources, which can then be manufactured into finished products.</p>
                    </div>
                    <div className="main-game-feature">
                        <GoatImage className="main-game-feature-image"/>
                        <h5 className="main-game-feature-title">Tradable nft</h5>
                        <p className="main-game-feature-text">All cards are tokenized as NFTs, providing proof of digital ownership by the player.  This means they can be traded, auctioned, or exchanged on 3rd party trading platforms.</p>
                    </div>
                    <div className="main-game-feature">
                        <PigImage className="main-game-feature-image"/>
                        <h5 className="main-game-feature-title">Collectibles</h5>
                        <p className="main-game-feature-text">Animal World offers exclusive lands, yield cards, and possession rights.  Each is unique and scarce, and is held in the owner's wax wallet.</p>
                    </div>
                    <div className="main-game-feature">
                        <CowImage className="main-game-feature-image"/>
                        <h5 className="main-game-feature-title">Real life farm</h5>
                        <p className="main-game-feature-text">Animal World is a representation of a REAL WORLD FARM.  As such, players will not only earn from playing the game, but have opportunities to receive products and earn from the real world.</p>
                    </div>
                    <img src={require("../../assets/gifs/grass.gif").default} alt="grass" className="main-game-feature-plant main-game-feature-plant-1"/>
                    <img src={require("../../assets/gifs/grass.gif").default} alt="grass" className="main-game-feature-plant main-game-feature-plant-2"/>
                    <img src={require("../../assets/gifs/grass.gif").default} alt="grass" className="main-game-feature-plant main-game-feature-plant-3"/>
                </div>
            </section>
            ...
            <section className="main-collect">
                ...
                >
                    ...
                    <div className="main-collect-slide main-collect-slide-4">
                        ...
                        <img src={require("../../assets/images/tree-legendary.gif").default} alt="legendary coconut tree"
                             className="main-collect-image"/>
                    </div>
                ...
                >
                    <div className="main-game-preview-slide">
                        <div className="main-game-preview-slide-content">
                            <img src={require("../../assets/images/game-preview-1.png").default} alt="game screenshot 2"
                                 className="main-game-preview-slide-image"/>
                            <div className="main-game-preview-slide-image-phone" style={{backgroundImage: `url(${gameplayScreenshot1})`}}/>
                        </div>
                    </div>
                    <div className="main-game-preview-slide">
                        <div className="main-game-preview-slide-content">
                            <img src={require("../../assets/images/game-preview-2.png").default} alt="game screenshot 2"
                                 className="main-game-preview-slide-image"/>
                            <div className="main-game-preview-slide-image-phone" style={{backgroundImage: `url(${gameplayScreenshot2})`}}/>
                        </div>
                    </div>
                </Carousel>
            </section>
            <section className="main-gameplay">
                ...
                <div className="main-gameplay-content">
                    ...
                    <img className="main-gameplay-decorations" src={require("../../assets/images/main-gameplay-decorations.png").default} alt="decorations"/>
                </div>
            </section>
        </div>
    )
