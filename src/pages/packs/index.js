          ...
          <Fade left>
            <div className="pack">
              ...
              <div className="pack-img-wrapper">
                <img
                  src={
                    require("../../assets/images/tree-pack-starter.png").default
                  }
                  alt="Tree starter pack"
                  className="pack-img"
                />
              </div>
              <div className="pack-wrapper">
                <div className="pack-info-wrapper">
                  ...
                  <div className="pack-info-cards">
                    ...
                    <div className="pack-info-card">
                      <span className="pack-info-card-name">
                        legendary card
                      </span>
                ...
                <div className="pack-button-wrapper">
                  <button className="pack-button pack-button-disabled" disabled>
                    Sold out
                  </button>
                  <a
                    className="pack-button"
                    href="https://wax.atomichub.io/market?collection_name=animalworld1&data:text.name=Starter%20Tree%20Pack%20V.1&order=desc&schema_name=packs&sort=created&symbol=WAX"
                    target="_blank"
                    rel="noreferrer"
                  >
                    Buy on secondary
          ...
          <Fade bottom>
            <div className="pack">
              ...
              <div className="pack-img-wrapper">
                <img
                  src={
                    require("../../assets/images/tree-pack-premium.png").default
                  }
                  alt="Tree premium pack"
                  className="pack-img"
                />
              </div>
              <div className="pack-wrapper">
                ...
                <div className="pack-button-wrapper">
                  ...
                  <a
                    href="https://wax.atomichub.io/market?collection_name=animalworld1&data:text.name=Premium%20Tree%20Pack%20V.1&order=desc&schema_name=packs&sort=created&symbol=WAX"
                    target="_blank"
                    rel="noreferrer"
                    className="pack-button"
                  >
          ...
          <Fade right>
            <div className="pack">
              ...
              <div className="pack-img-wrapper">
                <img
                  src={
                    require("../../assets/images/tree-pack-legendary.png")
                      .default
                  }
                  alt="Tree legendary pack"
                  className="pack-img pack-img-legendary"
                />
              </div>
              <div className="pack-wrapper pack-wrapper-legendary">
                <div className="pack-info-wrapper">
                  <div className="pack-info">
                    ...
                    <span className="pack-info-quantity pack-info-quantity-small">
                      20 premium packs
                    </span>
                ...
                <div className="pack-button-wrapper">
                  ...
                  <a
                    href="https://wax.atomichub.io/market?collection_name=animalworld1&data:text.name=Legendary%20Tree%20Pack%20V.1&order=desc&schema_name=packs&sort=created&symbol=WAX"
                    target="_blank"
                    rel="noreferrer"
                    className="pack-button"
                  >
